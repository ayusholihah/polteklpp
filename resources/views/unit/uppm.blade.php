    ...
    <section id="academic-administration" class="academic-administration section">
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="section-header text-center mb-5">
                <h2 class="unit-title">Unit Penelitian & Pengabdian Masyarakat</h2>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 align-items-center">
                    <div class="photo-frame">
                        <img src="assets/img/academic-photo.jpg" class="img-fluid rounded" alt="Academic Administration">
                    </div>
                </div>
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 content">
                    <div class="content">
                        ...
                        <!-- Vision -->
                        <div class="visimisi">
                            <h3 class="content-title"><i class="bi bi-caret-right-fill"></i> Visi</h3>
                            <p class="content-text">
                            Menjadi Perguruan Tinggi terbaik bidang perkebunan di tingkat global yang mampu menghasilkan lulusan yang profesional dan berkarakter                            </p>
                        </div>

                        <!-- Mission -->
                        <div class="visimisi">
                            <h3 class="content-title"><i class="bi bi-caret-right-fill"></i> Misi</h3>
                            <p class="content-text">
                                <ol>
